...
tinyMCE.init({
    ...
    imageupload_url: "{% url add-user-media %}",
    ...
    // Plugins
    plugins: 'imageupload,advimage,advlink,fullscreen,paste,media,searchreplace,grappelli,grappelli_contextmenu,template',
    ...
    theme_advanced_buttons2: 'imageupload,search,|,pasteword,template,media,charmap,|,code,|,table,cleanup,grappelli_documentstructure',
