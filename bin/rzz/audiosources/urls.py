...
urlpatterns = patterns('',
    ...
    url(r'^json/planning-duplicate/$', views.duplicate_planning , name="planning-duplicate"),
    url(r'^json/get-playing-element/$', views.get_playing_element, name='get-playing-element'),
    url_delete_model(AudioFile, 'audio-file'),
    url_delete_model(AudioSource, 'audio-source'),
    url_delete_model(Planning, 'planning'),
    ...
    url(r'^audiosource/(?P<audiosource_id>\d+)/playlist/$', views.audiosource_playlist, name="audiosource-playlist"),
    ...
    url(r'shared/detail/(?P<audiosource_id>\d+)/$', views.shared_content_detail, name="shared-content-detail"),
